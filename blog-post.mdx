...
On my Intel Iris Xe integrated GPU, I get around **10-15 tokens/second** with the Qwen 1.5B model. With a dedicated GPU, you can expect significantly better performance.

The first load downloads the model (700MB - 2GB depending on the model), but subsequent loads are nearly instant thanks to OPFS caching.
...
👉 [Browser SLM Chat on GitHub](https://github.com/henok/browser-slm-chat)
